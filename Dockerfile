# modified by cflagg to serve as a base image for dev
...
# this copies the shiny packages examples to the shiny-server folder, and launches them
# RUN cp -R /usr/local/lib/R/site-library/shiny/examples/* /srv/shiny-server/

RUN mkdir /home/rstudio/ShinyApps/

# this copies the shiny packages examples to this home/rstudio/ShinyApps/ dir
